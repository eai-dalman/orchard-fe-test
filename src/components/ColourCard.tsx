  ...
  return (
    <>
      <div>
        ...
        <dialog
          ref={dialogRef}
          className="[&::backdrop]:backdrop-blur-sm fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-transparent"
        >
          <div className="flex flex-col items-center w-[80dvw] sm:w-[50vw]">
